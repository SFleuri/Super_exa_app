...
describe User do
	...
	it { should respond_to(:name, :email, :password_digest, :password, :password_confirmation, :remember_token, :authenticate, :admin, :authenticate, :microposts, :feed, :relationships, :followed_users, :followers ) }
